...
public class ActivityScoreSuggestion {
    ...
    public ActivityScoreSuggestion(){
        ...
        suggestionMap.put(0.1D, "Verbessere deinen Activity Score indem du das Armband häufiger trägst!");
        suggestionMap.put(0.2D, "Dein Grundumsatz beeinflusst den Activity Score auch. Verbessere ihn indem du das Armband trägst!");
        suggestionMap.put(0.3D, "Dein Grundumsatz beeinflusst den Activity Score auch. Verbessere ihn indem du das Armband trägst!");
        ...
        suggestionMap.put(0.8D, "Der optimale Activity Score liegt bei 1,0. Du bist fast soweit!");
