...
public class GPSService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        activeRecordingID = (DataHolder_GPSDatabase.getInstance().getData().getLastRunID())+1;
    ...
    public void startTracking(){
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location l) {
                if (l != null) {
                    boolean ins = DataHolder_GPSDatabase.getInstance().getData().addData(activeRecordingID, l.getLatitude(), l.getLongitude(), l.getAltitude(),recordingAsBicycle);
                    if (!ins)
